...
/* ── helpers ── */
const spacer = (h = "40vh"): TemplateResult =>
  html` <div
    style="height:${h};background:var(--bg-surface);display:flex;align-items:center;
    justify-content:center;border-bottom:1px solid var(--border-subtle);"
  >
    <p
      style="font-family:var(--lib-font-mono);font-size:var(--text-xs);
...
export const Playground: Story = {
  ...
  render: (args): TemplateResult => html`
    <div>
      ...
      <div
        style="padding:var(--lib-space-xl) calc(var(--lib-space-xl) * 2);
      ...
      >
        ...
        >
          ${[1, 2, 3, 4].map(
            (n) => html`
              <div
                style="height:80px;margin-bottom:var(--lib-space-md);
...
export const Directions: Story = {
  ...
  render: (): TemplateResult => html`
    <div>
      ${spacer()}
      ${(["up", "down", "left", "right", "fade"] as const).map(
        (dir) => html`
          <div
            style="padding:var(--lib-space-xl) calc(var(--lib-space-xl) * 2);
            ...
            >
              <div style="display:flex;gap:var(--lib-space-md);">
                ${[1, 2, 3, 4, 5].map(
                  (n) => html`
                    <div
                      style="flex:1;height:64px;background:var(--color-washi-${n *
                        100 +
                      100});
                  border:1px solid var(--border-subtle);"
                    ></div>
...
export const ShibuiCards: Story = {
  ...
  render: (): TemplateResult => html`
    <div>
      ...
      <section
        style="padding:calc(var(--lib-space-xl)*3) calc(var(--lib-space-xl)*2);
        background:var(--bg-elevated);"
      >
        <div style="margin-bottom:calc(var(--lib-space-xl)*2);">
          ...
          <h2
            style="font-family:var(--lib-font-display);font-size:var(--text-3xl);
            font-weight:300;letter-spacing:var(--tracking-tight);line-height:1.2;"
          >
            Colección de<br /><em style="color:var(--color-kaki-500);"
              >componentes</em
            >
          </h2>
        </div>
            ...
            ${[
              {
                ...
                title: "Button",
                color: "kaki",
                desc: "5 variants + liquid",
              },
              {
                num: "02",
                title: "Dropdown",
                color: "celadon",
                desc: "4 trigger styles",
              },
              {
                num: "03",
                title: "Chip",
                color: "default",
                desc: "Static · Toggle · Input",
              },
              {
                num: "04",
                title: "Tabs",
                color: "kaki",
                desc: "5 variants, keyboard nav",
              },
              {
                num: "05",
                title: "Dialog",
                color: "celadon",
                desc: "Modal · Sheet · Popover",
              },
              {
                num: "06",
                title: "Sidebar",
                color: "default",
                desc: "Collapsible navigation",
              },
            ].map(
              (c) => html`
                <div
                  style="padding:var(--lib-space-lg);border:1px solid var(--border-subtle);
                background:var(--bg-base);"
                >
                  <p
                    style="font-family:var(--lib-font-mono);font-size:9px;
                  letter-spacing:var(--tracking-widest);text-transform:uppercase;
                  color:var(--text-muted);margin-bottom:var(--lib-space-sm);"
                  >
                    ${c.num}
                  ...
                  <h3
                    style="font-family:var(--lib-font-display);font-size:var(--text-xl);
      ...
      <div style="padding:var(--lib-space-xl) calc(var(--lib-space-xl)*2);">
        ...
        >
          ${[1, 2, 3].map(
            (n) => html`
              <div
                style="height:100px;margin-bottom:var(--lib-space-md);
          ...
          <lib-stagger-container delay="80" direction="up">
            ${['Wabi · Imperfección', 'Ma · El espacio', 'Shibui · Discreción'].map(txt => html`
              <div style="padding:10px 12px;background:var(--bg-elevated);border:1px solid var(--border-subtle);
                font-family:var(--lib-font-body);font-size:.875rem;color:var(--text-primary);">
                ${txt}
              </div>
            `)}
          </lib-stagger-container>
