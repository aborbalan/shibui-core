      ...
      ${katachiList.map(k => html`
        <section data-katachi="${k.id}" style="padding:var(--lib-space-lg);display:flex;flex-direction:column;gap:var(--lib-space-md);background:var(--bg-base);">
          ...
          <lib-tabs active="t1"
            ...
            <div slot="t1" style="padding:var(--lib-space-md);font-size:var(--text-sm);color:var(--text-secondary);">Sistema de diseño del katachi.</div>
            <div slot="t2" style="padding:var(--lib-space-md);font-size:var(--text-sm);color:var(--text-secondary);">Tokens semánticos heredados.</div>
            <div slot="t3" style="padding:var(--lib-space-md);font-size:var(--text-sm);color:var(--text-secondary);">Implementación Lit.</div>
          </lib-tabs>
        </section>
      `)}
    </div>
