 ...
 * @prop {ProgressTone} tone       — default · kaki · celadon · error. Default default.
 ...
 * <lib-metric-bar label="RAM"  value="12.4" max="32" unit="GB" show-value tone="kaki"></lib-metric-bar>
