...
/* ═══════════════════════════════════════════════════════════════
   ...
   lib-glass-card usa --lib-glass-* effect tokens que katachi
   ya controla. El fondo bg-base del contenedor adapta la
   visibilidad del efecto glass al contexto activo.
   ═══════════════════════════════════════════════════════════════ */

const _katachi = createKatachiStories<object>(() => html`
  <div style="background:var(--bg-base);padding:var(--lib-space-lg);">
    <lib-glass-card style="max-width:320px;">
