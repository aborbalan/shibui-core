    ...
    <div style=${stageDark}>
      <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:32px;width:100%;">
        <div style="display:flex;flex-direction:column;gap:12px;">
          ...
          <lib-counter value="22" thousands="" size="lg" surface="dark" label="En el sistema" play-on-visible></lib-counter>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;">
          ...
          <lib-counter value="148" thousands="" size="lg" surface="dark" label="Variables CSS" play-on-visible></lib-counter>
        </div>
        <div style="display:flex;flex-direction:column;gap:12px;">
          ...
          <lib-counter value="5" thousands="" size="lg" surface="dark" label="Variantes" play-on-visible></lib-counter>
        </div>
      </div>
    </div>
  `,
...
/* ═══════════════════════════════════════════════════════════════
   ...
   lib-counter usa tokens semánticos de superficie y tipografía
   (bg-base, text-primary, text-muted) — adapta al katachi.
   ═══════════════════════════════════════════════════════════════ */
